const MOCK_RESPONSES = {
  'Goku': [
    '¡Eso suena increíble! Me recuerda cuando entrené en el Cuarto del Espíritu y el Tiempo. ¡Tienes que superar tus límites!',
    '¡Ja! Un verdadero guerrero enfrenta eso con una sonrisa. ¿Quieres entrenar juntos algún día?',
  ...
  'Vegeta': [
    ...
    'Mi poder supera al de cualquier ser en este universo. Lo que me preguntas es casi irrelevante para alguien de mi nivel.',
    'Solo un bajo nivel haría esa pregunta. Pero como soy magnánimo, responderé esta única vez.',
  ],
  'Gohan': [
    'Eso es muy interesante. Creo que podríamos analizarlo desde distintos ángulos. ¿Qué sabes hasta ahora?',
    'Mi papá siempre dice que el esfuerzo lo es todo, y en esto también aplica. Investiguémoslo juntos.',
  ...
  'Bulma': [
    '¡Obvio! Con la tecnología Capsule Corporation eso se resuelve en cinco minutos. Déjame pensar...',
    'Eso tiene una explicación científica muy clara. Mi papá y yo lo analizamos hace años en el laboratorio.',
    '¡Genial pregunta! Aunque, siendo honesta, yo ya sé la respuesta. La cuestión es si puedes entenderla.',
  ],
  'Majin Buu': [
    ...
    'Buu sabe pocas cosas, pero sabe que los amigos son buenos. ¡Tú eres amigo de Buu!',
  ],
};
